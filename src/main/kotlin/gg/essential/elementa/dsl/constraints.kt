...
operator fun SuperConstraint<Float>.times(factor: SuperConstraint<Float>) = FactorConstraint(this, factor)

operator fun SuperConstraint<Float>.div(factor: Number) = ScaleConstraint(this, 1f / factor.toFloat())
operator fun SuperConstraint<Float>.div(factor: SuperConstraint<Float>) = FactorConstraint(this, factor)
